import { DatadogClient, clientFromEnvironment } from "./api.ts";
...
export class Datadog {
  ...
  async doHTTP(apiPath: string, payload: unknown) {
    try {
      ...
      console.error('WARN: Datadog request failed:',err.message);
      return err;
    }
  }
